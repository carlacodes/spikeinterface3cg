...
class TDTData:
    ...
    def save_ks_as_phy(self):
        ...
        export_to_phy(self.we, '/home/zceccgr/Scratch/zceccgr/Electrophysiological_Data//F1702_Zola_Nellie//warpspikeinterface_output10',
                      compute_pc_features=False, compute_amplitudes=True, copy_binary=True)
...
def run_ks2_cg(data, output_folder):
    ss.kilosort2['ops.lam'] = 50
    ss.kilosort2['ops.Th']=[8, 4]
...
def save_ks_as_phy_alone(data_test):
    ...
    export_to_phy(data_test, '/home/zceccgr/Scratch/zceccgr/Electrophysiological_Data//F1702_Zola_Nellie//warpspikeinterface_output10',
                  compute_pc_features=False, compute_amplitudes=True, copy_binary=True)
...
def main():
    ...
    output_folder = Path('/home/zceccgr/Scratch/zceccgr/Electrophysiological_Data/F1702_Zola_Nellie/warpspikeinterface_output10')
