...
#
    probe = generate_multi_columns_probe(num_columns=7,
                                         num_contact_per_column=4,
                                         xpitch=350, ypitch=350,
                                         contact_shapes='circle')
    probe.create_auto_shape('rect')
...
def save_as_phy_alone(data_test, rec):
    ...
    print(data_test.we)
    export_to_phy(data_test.we, '/home/zceccgr/Scratch/zceccgr/Electrophysiological_Data//F1702_Zola_Nellie//wpsoutput19',
                        compute_pc_features=False, compute_amplitudes=True, copy_binary=True)
    export_report(data_test.we, '/home/zceccgr/Scratch/zceccgr/Electrophysiological_Data//F1702_Zola_Nellie//wpsoutput20')
