...
class TDTData:
    ...
    def save_as_phy(self):
        ...
        export_to_phy(self.we, '/home/zceccgr/Scratch/zceccgr/Electrophysiological_Data//F1812_Nala//wpsoutput13',
...
def save_ks_as_phy_alone(data_test):
    ...
    export_to_phy(data_test, '/home/zceccgr/Scratch/zceccgr/Electrophysiological_Data//F1812_Nala//wpsoutput13',
                  compute_pc_features=False, compute_amplitudes=True, copy_binary=True)
...
def save_as_phy_alone(data_test, rec):
    ...
    print(data_test.we)
    export_to_phy(data_test.we, '/home/zceccgr/Scratch/zceccgr/Electrophysiological_Data//F1812_Nala//wpsoutput26112022bb2bb3//phy/',
                        compute_pc_features=False, compute_amplitudes=True, copy_binary=True)
    export_report(data_test.we, '/home/zceccgr/Scratch/zceccgr/Electrophysiological_Data//F1812_Nala//wpsoutput26112022bb2bb3//report')



def main():
    #/home/zceccgr/Scratch/zceccgr/Electrophysiological_Data/F1812_Nala
    datadir = Path('/home/zceccgr/Scratch/zceccgr/Electrophysiological_Data/F1812_Nala')
    ...
    output_folder = Path('/home/zceccgr/Scratch/zceccgr/Electrophysiological_Data/F1812_Nala/wpsoutput26112022bb2bb3')
    print('hello, concatenating neural data blocks now')
    
    for i in range(7,12): #[x for x in range(25,54) if x !=range(35,45)]: #range of intra trial roving stimuli for crumble
        print(i)
