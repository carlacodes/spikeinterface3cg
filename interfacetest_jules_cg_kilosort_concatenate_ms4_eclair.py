...
def save_as_phy_alone(data_test, rec):
    ...
    print(data_test.we)
    export_to_phy(data_test.we, '/home/zceccgr/Scratch/zceccgr/Electrophysiological_Data//F1902_Eclair//wpsoutput08112022bb2bb3//phy',
                        compute_pc_features=False, compute_amplitudes=True, copy_binary=True)
    export_report(data_test.we, '/home/zceccgr/Scratch/zceccgr/Electrophysiological_Data//F1902_Eclair//wpsoutput08112022bb2bb3//report//')
...
def main():
    ...
    output_folder = Path('/home/zceccgr/Scratch/zceccgr/Electrophysiological_Data/F1902_Eclair/wpsoutput08112022bb2bb3')
    ...
    for i in range(31, 51): #range of intra trial roving stimuli for crumble
        ...
        #if i == 34 or i == 35 or i == 44 or i == 50: for BB4bb5 
        if i == 35 or i==50:
            continue
