...
class TDTData:
    ...
    def save_as_phy(self):
        ...
        export_to_phy(self.we, '/home/zceccgr/Scratch/zceccgr/Electrophysiological_Data//F1901_Crumble//wpsoutput13',
...
def save_ks_as_phy_alone(data_test):
    ...
    export_to_phy(data_test, '/home/zceccgr/Scratch/zceccgr/Electrophysiological_Data//F1901_Crumble//wpsoutput13',
                  compute_pc_features=False, compute_amplitudes=True, copy_binary=True)
...
def save_as_phy_alone(data_test, rec):
    ...
    print(data_test.we)
    export_to_phy(data_test.we, '/home/zceccgr/Scratch/zceccgr/Electrophysiological_Data//F1901_Crumble//wpsoutput25102022',
                        compute_pc_features=False, compute_amplitudes=True, copy_binary=True)
    export_report(data_test.we, '/home/zceccgr/Scratch/zceccgr/Electrophysiological_Data//F1901_Crumble//wpsoutput25102022_2')



def main():
    #/home/zceccgr/Scratch/zceccgr/Electrophysiological_Data/F1901_Crumble
    ...
    output_folder = Path('/home/zceccgr/Scratch/zceccgr/Electrophysiological_Data/F1901_Crumble/wpsoutput16')
    ...
    channels_to_remove=             np.array([ 26, 28, 10, 12])-1
