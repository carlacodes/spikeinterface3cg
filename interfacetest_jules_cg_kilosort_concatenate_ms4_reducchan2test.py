...
#
    ...
    channel_indices = np.array([24, 22, 8, 6,
                                    20, 18, 4, 2])
    channel_indices = np.array([1,2,3,4,
                                5,6,7,8])
...
def save_as_phy_alone(data_test, rec):
    ...
    export_to_phy(data_test.we, '/home/zceccgr/Scratch/zceccgr/Electrophysiological_Data//F1702_Zola_Nellie//wpsoutput17repeat',
                    compute_pc_features=False, compute_amplitudes=True, copy_binary=True)
...
def main():
    ...
    output_folder = Path('/home/zceccgr/Scratch/zceccgr/Electrophysiological_Data/F1702_Zola_Nellie/wpsoutput16repeat')
